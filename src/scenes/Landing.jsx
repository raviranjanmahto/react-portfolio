      ...
      <div className='z-30 basis-2/5 mt-12 md:mt-32'>
        ...
        >
          ...
          <p className='mt-10 mb-7 text-sm text-center md:text-start'>
            A curious software engineering student with the ability to learn,
            adapt and grow. Eager to be challenged to improve software
            development skills. Able to effectively self-manage during
